package com.uplinkstatus.app.permissions
 ...
 * [com.uplinkstatus.app.state.UplinkRuntimeStatus] and
 * [com.uplinkstatus.app.state.UplinkActivityStatus] already use to carry facts between the
 ...
 * permission-request result, and [com.uplinkstatus.app.MainActivity]'s `onResume` for a grant
 * made outside the app entirely — and
 * [com.uplinkstatus.app.connectivity.ConnectivityManagerNetworkSnapshotProvider] collects
 ...
 * ([com.uplinkstatus.app.state.NetworkScopeMatcher]'s `hasLocationPermission` argument), which
