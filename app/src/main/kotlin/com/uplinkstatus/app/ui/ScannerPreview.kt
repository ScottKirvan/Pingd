 ...
 * [com.uplinkstatus.app.service.UplinkNotificationController] is showing in the notification
 * right now, read straight from [UplinkIconDisplay] — not a separate rendering, and not a
 * second interpretation of the tracer's state derived some other way.
 *
 * Renders nothing at all while [UplinkIconDisplay.iconRes] is `null`. Per spec, `HIDDEN` is
...
fun ScannerPreview(modifier: Modifier = Modifier) {
    val iconRes by UplinkIconDisplay.iconRes.collectAsState()
