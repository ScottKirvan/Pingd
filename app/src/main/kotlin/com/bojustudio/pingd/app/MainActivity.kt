...
import com.bojustudio.pingd.app.ui.NotificationPermissionScreen
import com.bojustudio.pingd.app.ui.SettingsScreen
import com.bojustudio.pingd.app.ui.theme.PingdStatusTheme

/**
 * Stage 2 added the `POST_NOTIFICATIONS` runtime-permission request/rationale flow (the
 * status-bar icon can't be shown at all without it) and starts [PingdStatusService] once
 ...
 * [PingdStatusService]'s preferences-collector doc).
 */
class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val preferencesRepository = DataStorePingdPreferencesRepository(
    ...
    private fun startPingdService() {
        ContextCompat.startForegroundService(this, PingdStatusService.createStartIntent(this))
    }
}
