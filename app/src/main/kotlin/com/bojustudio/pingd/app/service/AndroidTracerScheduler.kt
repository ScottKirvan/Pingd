 ...
 * running "on the main looper," but [com.bojustudio.pingd.core.probe.Prober.probe] is a
 * *blocking* call (TCP connect, up to 1000ms) that
 * [com.bojustudio.pingd.core.tracer.ProbeCycleRunner] invokes synchronously on whatever thread
 ...
 * individual block is bounded, not indefinite. [PingdStatusService] instead supplies a
 ...
 * UI thread. See `notes/dev/pingd-status-indicator-spec.md`'s Technical Notes, updated in
