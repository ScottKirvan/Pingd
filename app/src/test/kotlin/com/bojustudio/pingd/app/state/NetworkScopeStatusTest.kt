...
import com.bojustudio.pingd.app.connectivity.FakeNetworkSnapshotProvider
 ...
 * [FakePingdPreferencesRepository] -- no real `ConnectivityManager`, no real DataStore, no
...
class NetworkScopeStatusTest {
    ...
    fun `connectivity that has not reported yet is 'not known', never a plain out-of-scope false`() = runTest {
        ...
        val preferences = FakePingdPreferencesRepository(
            PingdPreferences(networkScope = NetworkScope.WIFI_ONLY),
        )
