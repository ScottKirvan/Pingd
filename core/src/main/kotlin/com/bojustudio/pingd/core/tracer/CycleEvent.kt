...
sealed interface CycleEvent {
     ...
     * [AckSource.PROBE_SUCCESS] (taken straight from the [com.bojustudio.pingd.core.probe.ProbeResult.Success]
     ...
     * accessibility text like "Ping'd: connected, 42ms" without needing to poll the prober
