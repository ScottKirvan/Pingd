...
class VisibilityDeciderTest {
    ...
    fun `full truth table over all 8 boolean combinations`() {
        val expected = mapOf(
            Triple(false, false, false) to PingdVisibility.HIDDEN,
            Triple(false, false, true) to PingdVisibility.HIDDEN,
            Triple(false, true, false) to PingdVisibility.HIDDEN,
            Triple(false, true, true) to PingdVisibility.HIDDEN,
            Triple(true, false, false) to PingdVisibility.DISABLED,
            Triple(true, false, true) to PingdVisibility.HIDDEN,
            Triple(true, true, false) to PingdVisibility.ENABLED,
            Triple(true, true, true) to PingdVisibility.ENABLED,
        )
